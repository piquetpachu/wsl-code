...
function GaleriaDeImagenes() {
  const [imagenes, setImagenes] = useState([
    { src: 'imgs/Celula Eucariota.png', alt: 'Imagen 1', caption: 'Pie de foto Imagen 1' },
    { src: 'imgs/celula procariota.png', alt: 'Imagen 2', caption: 'Pie de foto Imagen 2' },
    { src: 'imgs/Corazon.png', alt: 'Imagen 3', caption: 'Pie de foto Imagen 3' },
    { src: 'imgs/corazon2.png', alt: 'Imagen 4', caption: 'Pie de foto Imagen 4' }
  ]);
